export const books = [
  {
    ...
    thumbnail: "https://www.it-ebooks.info/images/ebooks/3/you_dont_know_js_scope__closures.jpg",
  ...
  },
  {
    ...
    publisher: "O'Reilly Media, Inc.",
    thumbnail: "http://akamaicovers.oreilly.com/images/9780596517748/cat.gif",
  ...
  },
  {
    ...
    publisher: "O'Reilly Media, Inc.",
    thumbnail: "http://akamaicovers.oreilly.com/images/9780596805531/cat.gif",
  ...
  },
  {
    ...
    author: "Azat Mardan",
    publisher: "Apress",
    thumbnail: "https://camo.githubusercontent.com/7b89e5b57d40a3a4de1b1b5c381be56b254ed376/687474703a2f2f617a61747a62773462737a7a73622e7770656e67696e652e6e6574646e612d63646e2e636f6d2f77702d636f6e74656e742f75706c6f6164732f3831414970596b4134364c2d3230302e6a706567",
    description: "Practical Node.js is your step-by-step guide to learning how to build a wide range of scalable real-world web applications using a professional development toolkit. Node.js is an innovative and highly efficient platform for creating web services. But Node.js doesn't live in a vacuum! In a modern web development, many different components need to be put together — routing, database driver, ORM, session management, OAuth, HTML template engine, CSS compiler and many more. If you already know the basics of Node.js, now is the time to discover how to bring it to production level by leveraging its vast ecosystem of packages. As a web developer, you'll work with a varied collection of standards and frameworks - Practical Node.js shows you how all those pieces fit together. Practical Node.js takes you from installing all the necessary modules to writing full-stack web applications by harnessing the power of the Express.js and Hapi frameworks, the MongoDB database with Mongoskin and Mongoose, Jade and Handlebars template engines, Stylus and LESS CSS languages, OAuth and Everyauth libraries, and the Socket.IO and Derby libraries, and everything in between. The book also covers how to deploy to Heroku and AWS, daemonize apps, and write REST APIs. You'll build full-stack real-world Node.js apps from scratch, and also discover how to write your own Node.js modules and publish them on NPM. You already know what Node.js is; now learn what you can do with it and how far you can take it!"
  },
  {
